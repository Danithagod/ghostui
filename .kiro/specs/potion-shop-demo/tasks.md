...
- [ ] 1. Set up demo app project structure
  ...
  - [x] 1.1 Create Next.js app at `apps/demo` with TypeScript configuration
  ...
  - [x] 1.2 Create base layout with ThemeProvider and ambient effects
...
- [x] 2. Implement mock data and state management





  - [x] 2.1 Create mock product data
  ...
  - [x] 2.2 Implement useCart hook for cart state management
  ...
  - [x] 2.4 Implement useProducts hook for filtering and search
...
- [x] 4. Implement layout and navigation components
  ...
  - [x] 4.3 Implement sidebar navigation with GooeySidebar
...
- [x] 6. Implement drawer components


  - [x] 6.1 Implement ProductDrawer component
  ...
  - [x] 6.3 Implement CartDrawer component
...
- [x] 8. Implement toast notifications
  ...
  - [x] 8.1 Add GhostToast for cart notifications
...
- [x] 9. Implement checkout flow


  - [x] 9.1 Implement CheckoutModal component
  ...
  - [x] 9.2 Implement OrderProgress component
...
- [x] 10. Wire up main page



  - [x] 10.1 Integrate all components in main page
